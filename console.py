...
class WaveInterface(ctk.CTk):
    ...
    def _build_content_area(self):
        ...
        # === WAVE BACKGROUND - Placed directly on content frame ===
        ...
        # Scrollable page container - NOW TRANSPARENT
        ...
        # Make internal frames transparent
        try:
    ...
    def _build_vpn_page(self):
        frame = ctk.CTkFrame(self.page_container, fg_color="transparent")
        PageTitle(frame, "VPN", "Import VPN configs and manage bypass rules").pack(fill="x", pady=(0, 18))
